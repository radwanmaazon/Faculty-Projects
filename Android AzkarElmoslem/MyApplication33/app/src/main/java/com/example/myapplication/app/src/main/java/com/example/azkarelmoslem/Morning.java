...
import com.example.azkarelmoslem.Sabah_1;
import com.example.azkarelmoslem.takalap;
...
public class Morning extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bt_6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent takalap=new Intent(getBaseContext(), com.example.azkarelmoslem.takalap.class);
